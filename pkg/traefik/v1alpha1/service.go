...
// BeagleService is the specification for a service (that an IngressRoute refers
...
// (children) services, which themselves can be BeagleServices or Services.
type BeagleService struct {
...
// BeagleServiceList is a list of BeagleService resources.
type BeagleServiceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata"`

	Items []BeagleService `json:"items"`
}

// +k8s:deepcopy-gen=true

// ServiceSpec defines whether a BeagleService is a load-balancer of services or a
// mirroring service.
