...
// or a BeagleService object (a traefik load-balancer of services).
type LoadBalancerSpec struct {
	// Name is a reference to a Kubernetes Service object (for a load-balancer of servers),
	// or to a BeagleService object (service load-balancer, mirroring, etc).
	...
	// Weight should only be specified when Name references a BeagleService object
